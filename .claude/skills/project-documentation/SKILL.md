...
description: >
  Generate comprehensive, accurate documentation for a service/repository from its actual
  contents — architecture, inputs/outputs, external services and integrations, data flow,
  business logic, data contracts, configuration, and project structure. Use when asked to
  "document this project/service", "create repository docs", "write architecture docs",
  "describe the system end to end", or "initialize documentation". Produces written files
  (a committed docs/ + README.md set, or a git-ignored .agent-docs/ scratch folder) — it
  does not just navigate the repo. Never invents endpoints/fields/behavior (marks gaps
  "TODO: confirm"); never pastes secret values into docs; never commits or pushes.
---
