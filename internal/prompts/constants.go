...
var ApplicationPrompts = Prompts{
	PromptGroups: map[string]PromptGroup{
		PromptCategoryProofread: {
			...
			SystemPrompt: Prompt{ID: "systemProofread", Name: "System Proofread", Type: PromptTypeSystem, Category: PromptCategoryProofread, Value: systemPromptProofreading},
		...
		PromptCategoryFormat: {
			...
			SystemPrompt: Prompt{ID: "systemFormat", Name: "System Format", Type: PromptTypeSystem, Category: PromptCategoryFormat, Value: systemPromptFormatting},
			Prompts: map[string]Prompt{
		...
		PromptCategorySummary: {
			...
			SystemPrompt: Prompt{ID: "systemSummary", Name: "System Translate", Type: PromptTypeSystem, Category: PromptCategorySummary, Value: systemPromptSummarization},
			Prompts: map[string]Prompt{
		...
		PromptCategoryTranslation: {
			...
			SystemPrompt: Prompt{ID: "systemTranslate", Name: "System Translate", Type: PromptTypeSystem, Category: PromptCategoryTranslation, Value: systemPromptTranslation},
			Prompts: map[string]Prompt{
		...
		PromptCategoryTransforming: {
			...
			SystemPrompt: Prompt{ID: "systemTransforming", Name: "System Transforming", Type: PromptTypeSystem, Category: PromptCategoryTransforming, Value: systemPromptTransforming},
			Prompts: map[string]Prompt{
