...
const (
	...
	PromptCategoryTranslation   = "Translate"
	PromptCategoryProofread     = "Proofread"
	PromptCategoryFormat        = "Format"
	PromptCategorySummary       = "Summarize"
	PromptCategoryTransforming  = "Transform"
...
var ApplicationPrompts = Prompts{
	PromptGroups: map[string]PromptGroup{
		PromptCategoryProofread: {
			...
			SystemPrompt: Prompt{ID: "systemProofread", Name: "System Proofread", Type: PromptTypeSystem, Category: PromptCategoryProofread, Value: systemPromptProofreading, Description: "System-level proofreading and text transformation engine"},
			Prompts: map[string]Prompt{
				"proofread":         {ID: "proofread", Name: "Proofread", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userProofreadingBase, Description: "Proofreads the text and fixes grammar issues and fixes mistakes in the words"},
				"rewrite":           {ID: "rewrite", Name: "Rewrite", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingBase, Description: "Rewrites the text while preserving the original meaning and intent"},
				"rewriteFormal":     {ID: "rewriteFormal", Name: "Formal", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingFormalStyle, Description: "Rewrites the text in a formal and professional style"},
				"rewriteSemiFormal": {ID: "rewriteSemiFormal", Name: "Semi Formal", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingSemiFormalStyle, Description: "Rewrites the text in a semi-formal, professional yet approachable style"},
				"rewriteCasual":     {ID: "rewriteCasual", Name: "Casual", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingCasualStyle, Description: "Rewrites the text in a relaxed and conversational style"},
				"rewriteFriendly":   {ID: "rewriteFriendly", Name: "Friendly", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingFriendlyStyle, Description: "Rewrites the text in a warm and approachable friendly style"},
				"rewriteDirect":     {ID: "rewriteDirect", Name: "Direct", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingDirectStyle, Description: "Rewrites the text in a concise and results-oriented direct style"},
				"rewriteIndirect":   {ID: "rewriteIndirect", Name: "Indirect", Type: PromptTypeUser, Category: PromptCategoryProofread, Value: userRewritingIndirectStyle, Description: "Rewrites the text in a tactful and diplomatically phrased indirect style"},
			},
		},
		PromptCategoryFormat: {
			GroupID:      "002",
			GroupName:    PromptCategoryFormat,
			SystemPrompt: Prompt{ID: "systemFormat", Name: "System Format", Type: PromptTypeSystem, Category: PromptCategoryFormat, Value: systemPromptFormatting, Description: "System-level text formatting and transformation engine"},
			Prompts: map[string]Prompt{
				"formatFormalEmail":      {ID: "formatFormalEmail", Name: "Formal Email", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatFormalEmail, Description: "Formats the text as a formal professional email"},
				"formatCasualEmail":      {ID: "formatCasualEmail", Name: "Casual Email", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatCasualEmail, Description: "Formats the text as a casual friendly email"},
				"formatForChat":          {ID: "formatForChat", Name: "Chat", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatForChat, Description: "Formats the text as a short direct chat message"},
				"formatInstructionGuide": {ID: "formatInstructionGuide", Name: "Instruction Guide", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatInstructionGuide, Description: "Formats the text as a step-by-step instruction guide"},
				"formatPlainDocument":    {ID: "formatPlainDocument", Name: "Plain Document", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatPlainDocument, Description: "Formats the text as a clean sectioned plain document"},
				"formatSocialMediaPost":  {ID: "formatSocialMediaPost", Name: "Social Media Post", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatSocialMediaPost, Description: "Formats the text as a social media ready post"},
				"formatWikiMarkdown":     {ID: "formatWikiMarkdown", Name: "Wiki Markdown", Type: PromptTypeUser, Category: PromptCategoryFormat, Value: userFormatWikiMarkdown, Description: "Formats the text as structured wiki markdown"},
			},
		},
		PromptCategorySummary: {
			GroupID:      "003",
			GroupName:    PromptCategorySummary,
			SystemPrompt: Prompt{ID: "systemSummary", Name: "System Translate", Type: PromptTypeSystem, Category: PromptCategorySummary, Value: systemPromptSummarization, Description: "System-level text summarization and analysis engine"},
			Prompts: map[string]Prompt{
				"summaryBase":        {ID: "summaryBase", Name: "Summarize", Type: PromptTypeUser, Category: PromptCategorySummary, Value: userSummarizeBase, Description: "Creates a concise summary of the text"},
				"summaryKeypoints":   {ID: "summaryKeypoints", Name: "Create Key Points", Type: PromptTypeUser, Category: PromptCategorySummary, Value: userSummarizeKeypoints, Description: "Extracts concise factual keypoints from the text"},
				"summaryHashtags":    {ID: "summaryHashtags", Name: "Generate Hashtags", Type: PromptTypeUser, Category: PromptCategorySummary, Value: userSummarizeHashtags, Description: "Generates relevant hashtags derived from the text content"},
				"summaryExplanation": {ID: "summaryExplanation", Name: "Explain text", Type: PromptTypeUser, Category: PromptCategorySummary, Value: userSummarizeExplain, Description: "Rewrites text into clear simple language and explains technical terms"},
			},
		},
		PromptCategoryTranslation: {
			GroupID:      "004",
			GroupName:    PromptCategoryTranslation,
			SystemPrompt: Prompt{ID: "systemTranslate", Name: "System Translate", Type: PromptTypeSystem, Category: PromptCategoryTranslation, Value: systemPromptTranslation, Description: "System-level high-fidelity translation engine"},
			Prompts: map[string]Prompt{
				"translatePlain":      {ID: "translatePlain", Name: "Translate", Type: PromptTypeUser, Category: PromptCategoryTranslation, Value: userTranslatePlain, Description: "Translates text from one language to another with high fidelity"},
				"translateDictionary": {ID: "translateDictionary", Name: "Translate as Dictionary", Type: PromptTypeUser, Category: PromptCategoryTranslation, Value: userTranslateDictionary, Description: "Creates a dictionary-style translation table with examples"},
			},
		},
