...
if (!HTMLElement.prototype.setPointerCapture) {
    HTMLElement.prototype.setPointerCapture = (_pointerId: number): void => { return; };
}
if (!HTMLElement.prototype.releasePointerCapture) {
    HTMLElement.prototype.releasePointerCapture = (_pointerId: number): void => { return; };
}

// Radix Select scrolls items into view when the dropdown opens; jsdom stubs this.
if (!HTMLElement.prototype.scrollIntoView) {
    HTMLElement.prototype.scrollIntoView = (): void => { return; };
}
