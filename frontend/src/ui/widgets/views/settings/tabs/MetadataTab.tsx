...
const MetadataTab: React.FC = () => {
    ...
    return (
        <section style={{ padding: 'var(--space-4)', display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <p style={{ margin: '0 0 var(--space-4)', fontSize: '0.8125rem', color: 'var(--ink-3)' }}>
                Wails · Go · React
            </p>
            ...
            <div style={fieldRow}>
                ...
                <Button
                    ...
                    onClick={() => { handleCopyPath(settingsFile).catch(() => undefined); }}
                >
                    ⧉
                </Button>
            </div>
            ...
            <div style={{ ...fieldRow, borderBottom: 'none' }}>
                ...
                <Button
                    ...
                    onClick={() => { handleCopyPath(logsFolder).catch(() => undefined); }}
                >
                    ⧉
                </Button>
            </div>
            ...
            <AlertDialog
                ...
                variant="danger"
                onConfirm={() => { setResetDialogOpen(false); handleConfirmReset().catch(() => undefined); }}
            />
        </section>
    );
};
