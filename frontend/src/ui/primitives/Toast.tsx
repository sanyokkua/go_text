...
const VARIANT_ICONS: Record<ToastVariant, string> = { success: '✓', error: '⚠', warning: '⚠', progress: '◌', info: 'ℹ' };
...
const SingleToast: React.FC<SingleToastProps> = ({ id, variant = 'success', title, message, duration = 5000, onDismiss }) => (
    ...
    >
        ...
        <RadixToast.Close asChild>
            <button type="button" className={styles.close} aria-label="Dismiss notification">
                ✕
            </button>
        </RadixToast.Close>
    </RadixToast.Root>
