...
export class ActionService implements IActionService {
    ...
    async getActionGroups(): Promise<FrontActions> {
        try {
            ...
            this.loggerService.error(`ActionService.getActionGroups failed: ${error}`);
    ...
    async processAction(actionRequest: FrontActionRequest): Promise<string> {
        try {
            ...
            this.loggerService.error(`ActionService.processAction failed: ${error}`);
...
export class SettingsService implements ISettingsService {
    ...
    async createNewProvider(providerConfig: FrontProviderConfig, modelName?: string): Promise<FrontProviderConfig> {
        try {
            ...
            this.loggerService.error(`SettingsService.createNewProvider failed: ${error}`);
    ...
    async deleteProvider(providerConfig: FrontProviderConfig): Promise<boolean> {
        try {
            ...
            this.loggerService.error(`SettingsService.deleteProvider failed: ${error}`);
    ...
    async getCurrentSettings(): Promise<FrontSettings> {
        try {
            ...
            this.loggerService.error(`SettingsService.getCurrentSettings failed: ${error}`);
    ...
    async getDefaultSettings(): Promise<FrontSettings> {
        try {
            ...
            this.loggerService.error(`SettingsService.getDefaultSettings failed: ${error}`);
    ...
    async getModelsList(providerConfig: FrontProviderConfig): Promise<Array<string>> {
        try {
            ...
            this.loggerService.error(`SettingsService.getModelsList failed: ${error}`);
    ...
    async getProviderTypes(): Promise<Array<string>> {
        try {
            ...
            this.loggerService.error(`SettingsService.getProviderTypes failed: ${error}`);
    ...
    async getSettingsFilePath(): Promise<string> {
        try {
            ...
            this.loggerService.error(`SettingsService.getSettingsFilePath failed: ${error}`);
    ...
    async saveSettings(settings: FrontSettings): Promise<FrontSettings> {
        try {
            ...
            this.loggerService.error(`SettingsService.saveSettings failed: ${error}`);
    ...
    async selectProvider(providerConfig: FrontProviderConfig): Promise<FrontProviderConfig> {
        try {
            ...
            this.loggerService.error(`SettingsService.selectProvider failed: ${error}`);
    ...
    async updateProvider(providerConfig: FrontProviderConfig): Promise<FrontProviderConfig> {
        try {
            ...
            this.loggerService.error(`SettingsService.updateProvider failed: ${error}`);
    ...
    async validateProvider(providerConfig: FrontProviderConfig, validateHttpCall: boolean, modelName?: string): Promise<boolean> {
        try {
            ...
            this.loggerService.error(`SettingsService.validateProvider failed: ${error}`);
...
export class ClipboardService implements IClipboardService {
    ...
    async clipboardGetText(): Promise<string> {
        try {
            ...
            this.loggerService.error(`ClipboardService.clipboardGetText failed: ${error}`);
    ...
    async clipboardSetText(text: string): Promise<boolean> {
        try {
            ...
            this.loggerService.error(`ClipboardService.clipboardSetText failed: ${error}`);
